package com.bastlibrary.adapter;
...
//    public JustifyTextView getJustifyTextView(int viewId) {
//        return retrieveView(viewId);
//    }
    // //   public FontTextView getFontTextView(int viewId) {
//        return retrieveView(viewId);
//    }
...
//    }
//
//    public FrescoRoundView getFrescoRoundView(int viewId) {
//        return retrieveView(viewId);
//    }

    public XRecyclerView getXRecyclerView(int viewId) {
        return retrieveView(viewId);
    }
